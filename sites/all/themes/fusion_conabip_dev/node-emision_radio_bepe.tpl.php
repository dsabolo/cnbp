...
$linkAudio = l('<img alt="Reproducir" title="Reproducir" src="'.base_path().path_to_theme().'/css/images/video_play.png" style="height:14px; width:auto"> Reproducir','node/'.$node->nid,array('attributes'=>array('target'=>'_blan
...
$linkArchivo = '&nbsp;&nbsp;&nbsp;'.l('<img alt="Obtener archivo de audio" title="Obtener archivo de audio" src="'.base_path().path_to_theme().'/css/images/arrow_down.png" style="height:14px; width:auto"> Descargar archivo de audio',$node->field_audio[0]['filepath'],array('html'=>true));
$linkArchivo = '&nbsp;&nbsp;&nbsp;<a href="http://www.conabip.gob.ar/descarga.php?archivo='.$node->field_audio[0]['filepath'].'"><img alt="Obtener archivo de audio" title="Obtener archivo de audio" src="'.base_path().path_to_theme().'/css/images/arrow_down.png" style="height:14px; width:auto"> Descargar archivo de audio</a>';
...
//print_r($node);
	...
	print '<html><head><style>* { margin:0; padding:0} body { background:#111;} ul , #sb-loading {display:none;}</style></head><body><div style="background:#111; height:140px !important; width:220px !important; overflow:hidden;">';
...
?>
	<div class="teaser teaserAgendaBP" style="width:720px !important; background:#e1e1e1;padding:8px!important">
		...
		<?php if($fotoURL){
				...
				print l(theme('imagecache','short',$fotoURL),'node/'.$node->nid,array('attributes'=>array('target'=>'_blan
k','onclick'=>'window.open(this.href,"Conabip Radio","directories=no, location=no, menubar=no, scrollbars=no, statusbar=no, tittlebar=no, width=220, height=140"); return false;'),'html'=>true, 'query'=>'myajax=1'));
			}
		...
		if(!$fotoURL){
			...
			if($term->tid==3046) {
					...
					print l('<img src="http://www.conabip.gob.ar/sites/all/themes/fusion_conabip_dev/css/images/radioBPNAC.gif">','node/'.$node->nid,array('attributes'=>array('target'=>'_blan
k','onclick'=>'window.open(this.href,"Conabip Radio","directories=no, location=no, menubar=no, scrollbars=no, statusbar=no, tittlebar=no, width=220, height=140"); return false;'),'html'=>true, 'query'=>'myajax=1'));
			}
			if($term->tid==2893) {
				//print '<img src="http://www.conabip.gob.ar/sites/all/themes/fusion_conabip_dev/css/images/radioBPCNBP.gif">';
				print l('<img src="http://www.conabip.gob.ar/sites/all/themes/fusion_conabip_dev/css/images/radioBPCNBP.gif">','node/'.$node->nid,array('attributes'=>array('target'=>'_blan
k','onclick'=>'window.open(this.href,"Conabip Radio","directories=no, location=no, menubar=no, scrollbars=no, statusbar=no, tittlebar=no, width=220, height=140"); return false;'),'html'=>true, 'query'=>'myajax=1'));
			}
			if($term->tid!=2893 && $term->tid!=3046 ){
			//print '<img src="http://www.conabip.gob.ar/sites/all/themes/fusion_conabip_dev/css/images/RADIOTECA_IMAGEN_2.gif">';
			
			print l('<img src="http://www.conabip.gob.ar/sites/all/themes/fusion_conabip_dev/css/images/RADIOTECA_IMAGEN_2.gif">','node/'.$node->nid,array('attributes'=>array('target'=>'_blan
k','onclick'=>'window.open(this.href,"Conabip Radio","directories=no, location=no, menubar=no, scrollbars=no, statusbar=no, tittlebar=no, width=220, height=140"); return false;'),'html'=>true, 'query'=>'myajax=1'));
